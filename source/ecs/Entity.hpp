...
namespace ECS
{
     ...
     */
    class Entity// : BaseECS::Entity
    {
    public:
        /**
         * @brief Basic Entity constructur, Default ECS::Entity ID.
         * !!Note!! Ment to be a temporary instantiation! Make sure you use Instantiate() to get legal id.
         */
        Entity();

        /**
         * @brief Entity constructor. Should NOT be used for new entity generation except for ECS::EntityMgr.
         * 
        ...
        */
        ...
        Tclass* CreateComponent()
        {
            ...
            {
                std::cout << "CreateComponent() accepts only classes derived from ECS::Component";
                return 0;
            }
